...
Trans_script_path="/home/local/ARCS/xw2629/softwares/Hyper-editing" # if needed insert the proper path to the transform scripts ("a2c.pl" "a2g.pl" "a2t.pl" "g2c.pl" "t2c.pl" "t2g.pl")
