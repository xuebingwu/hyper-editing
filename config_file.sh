...
source_file="/home/local/ARCS/xw2629/xuebing/RNA-editing/LM2vs231/file_list" # path+full_name of the input files to run: fastq_file_path+name	/TAB/ out_prefix (if the input files are of paired-end reads, each of the paired files should appear in separate line).

genome_bwa_ind="/home/local/ARCS/xw2629/genomes/sequences/hg38" # path+prefix of the index genome expected 5 files like: prefix.amb, prefix.ann, prefix.bwt, prefix.pac, prefix.sa

genome_trans_bwa_ind="/home/local/ARCS/xw2629/genomes/sequences/hg38" # path+prefix of the index transformed genome: for each of the 6 transformed (a2c a2g a2t g2c t2c t2g)=>tt: 5 files: prefix.tt.amb, prefix.tt.ann, prefix.tt.bwt, prefix.tt.pac, prefix.tt.sa + 1 fasta file prefix.tt.fa => tot 36 files

genome_fasta="/home/local/ARCS/xw2629/genomes/sequences/hg38.fa" # path+full_name of the fasta file of the original genome
